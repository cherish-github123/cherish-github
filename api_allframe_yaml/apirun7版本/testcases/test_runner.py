...
import pytest
import requests
from api_allframe_yaml.apirun7版本.keywords.keyword import Keyword
import allure
from api_allframe_yaml.apirun7版本.Utils.VarRender import var_render
from api_allframe_yaml.apirun7版本.Global_var.global_var import GlobalVar
from api_allframe_yaml.apirun7版本.Utils.yamlfileread import YamlFileRead


class TestRunner():
    # TODO 1.读取yaml文件，获取用例信息,每一条用例信息就是一个字典
    case_info = YamlFileRead().read_yaml(
        r"E:\华测讲师笔记\hctestcode\apitestframe-new\api_allframe_yaml\apirun7版本\data\yaml\登录接口测试用例.yaml")
