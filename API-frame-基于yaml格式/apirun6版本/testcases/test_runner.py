...
import pytest
import requests
from api_allframe_yaml.apirun6版本.keywords.keyword import Keyword
import allure
from api_allframe_yaml.apirun6版本.Utils.VarRender import var_render
from api_allframe_yaml.apirun6版本.Global_var.global_var import GlobalVar
from api_allframe_yaml.apirun6版本.Utils.yamlfileread import YamlFileRead
...
class TestRunner():
    ...
    case_info = YamlFileRead().read_yaml(
        r"E:\华测讲师笔记\hctestcode\apitestframe-new\api_allframe_yaml\apirun6版本\data\yaml\登录接口测试用例.yaml")
